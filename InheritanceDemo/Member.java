...
abstract public class Member {
    ...
    public void setDiscount(){
        ...
        if(!password.equals("abcd")){
            System.out.println("Invalid password. You dp not have authority to edit the discount.");
        }
        else{
            System.out.println("Please eter the discount");
    ...
    abstract public void calculaterAnnualFee();
